# Contributing to gmail-order-bot
...
We have a [reference file](https://github.com/lsiodev/docker-jenkins-builder/blob/master/vars/_container-vars-blank) in our Jenkins Builder.
...
docker build \
  --no-cache \
  --pull \
  -t lsiodev/gmail-order-bot:latest .
```
